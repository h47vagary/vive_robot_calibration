...
public:
    ...
    virtual void filter_position(std::vector<CartesianPose>& trajectory) = 0;
    virtual void filter_orientation(std::vector<CartesianPose>& trajectory) = 0;    
    virtual void filter_xyzabc(std::vector<double>& x,
                               std::vector<double>& y,
                               std::vector<double>& z,
                               std::vector<double>& a,
                               std::vector<double>& b,
    ...
    virtual void set_filter_param(size_t window_size) = 0;
};

class MovingAverageFilter : public IPoseFilter
{
public:
    explicit MovingAverageFilter(size_t window_size = 5);

    void filter_position(std::vector<CartesianPose>& trajectory) override;
    void filter_orientation(std::vector<CartesianPose>& trajectory) override;
    ...
    void set_filter_param(size_t window_size) override;
